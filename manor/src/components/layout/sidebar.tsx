...
export function Sidebar() {
  ...
  return (
    <nav className="w-60 h-screen flex flex-col border-r border-neutral-800 bg-neutral-900/50">
      {/* Logo */}
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 space-y-6">
        {navigation.map((section) => (
          <div key={section.title}>
            <h2 className="px-2 mb-1.5 text-[11px] font-medium uppercase tracking-wider text-neutral-500">
              {section.title}
            </h2>
      ...
      <div className="px-4 py-3 border-t border-neutral-800/60">
        ...
        <p className="text-[10px] text-neutral-600 pl-4">v0.1.0</p>
      </div>
    </nav>
  );
}
